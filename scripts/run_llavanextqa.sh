...
python mainllavanext.py \
    ...
    --setting "QSVD/sqa/beta_then_qkvlm_svdgrad_ITv5_a100/labelqa/llavaaclip${aclipratio}_ratio${rank_ratio}${svd_mode}_mean${bs}_alpha=0.5_beta${beta_lr}_${beta_epochs}_bs${bs}/seed${seed}" \
    --beta_lr "$beta_lr" \
